<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
        <div class="col-lg-12 mb-4 order-0">
            ...
            <div class="card mb-2">
                <h5 class="card-header">Canggah H.Shomad/Hj.Marsinah</h5>
            </div>
            <div class="card">
                <div class="card-body">
                    ...
                    <table id="example" class="table">
                        ...
                        <tbody>
                            <?php
                            $no = 0;
                            $sql = mysqli_query($connect, "SELECT * FROM canggah ORDER BY kodepernikahan");
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        // get ibu bapak
                                                        $sql1 = mysqli_query($connect, "SELECT pn.nama as ibu, ptr.nama as bapak FROM buyut_nikah pn JOIN buyut ptr ON pn.kodepasangan = ptr.id WHERE pn.kodepernikahan = '$kode'");
