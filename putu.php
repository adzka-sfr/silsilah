<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
        <div class="col-lg-12 mb-4 order-0">
            ...
            <div class="card mb-2">
                <h5 class="card-header">Putu H.Shomad/Hj.Marsinah</h5>
            </div>
            <div class="card">
                <div class="card-body">
                    ...
                    <table id="example" class="table">
                        ...
                        <tbody>
                            <?php
                            $no = 0;
                            $sql = mysqli_query($connect, "SELECT * FROM putu ORDER BY kodepernikahan");
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        // get ibu bapak
                                                        $sql1 = mysqli_query($connect, "SELECT pn.nama as ibu, ptr.nama as bapak FROM putra_nikah pn JOIN putra ptr ON pn.kodepasangan = ptr.id WHERE pn.kodepernikahan = '$kode'");
                                                        ...
                                                        <br>
                                                        <br>
                                                        Umur <?= $anak ?> sekarang adalah <?= $interval->format("%y") . " tahun " . $interval->format("%m") . " bulan " . $interval->format("%d") . " hari " ?>
                                                    </div>
